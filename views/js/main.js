...
var resizePizzas = function(size) {
  ...
  /*
   Moved calculation of newwidth outside of loop since it needs to be calculated only once
   */
  function changePizzaSizes(size) {
    // Moved dx outside of loop, only need to know size of 1 pizza, they should all be the same size.
...
/*
 Moved reference to randomPizzas outside of loop so it is not recalculated 98 times
 */
...
/*
 Stored item array outside of function since it is not changed
 */
...
/*
 Modified function to produce only 32 elements vs 200.
 */
